...
corr_matrix = np.corrcoef(I0LT, I1LT[:160])
...
mapep =  mean_absolute_percentage_error(I0LT, I1LT[:160])
print("MAPE:", mapep)

#EV
ev = (explained_variance_score(I0LT, I1LT[:160]))
print("EV:",ev)

#RMSE
RMSE = np.sqrt(mean_squared_error(I0LT, I1LT[:160]))
print("RMSE:", RMSE)
