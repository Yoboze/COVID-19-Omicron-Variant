...
corr_matrix = np.corrcoef(I0AT, I1AT[:160])
...
mapep =  mean_absolute_percentage_error(I0AT, I1AT[:160])
print("MAPE_A:", mapep)

#EV
ev = (explained_variance_score(I0AT, I1AT[:160]))
print("EV_A:",ev)

#RMSE
RMSE = np.sqrt(mean_squared_error(I0AT, I1AT[:160]))
print("RMSE_A:", RMSE)
